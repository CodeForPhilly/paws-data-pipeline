...
#
# This is setup to be run as python3  

# importing csv module
import csv

# PATH TO DATA FILES  <<<< Can turn this into a parameter too
FilesPathname = "/Users/ckohl/Dropbox/PAWS_Data_Pipeline_Project/SFDC_Playground/PAWS_Data_2020_POC"
...
FullPathInputFilename = FilesPathname + "/" + InputFilename
FullPathOutputFilename = FilesPathname + "/" + OutputFilename
...
# reading csv file
with open(FullPathInputFilename, 'r') as csvfile:
...
# writing to csv file
with open(FullPathOutputFilename, 'w') as csvfile:
