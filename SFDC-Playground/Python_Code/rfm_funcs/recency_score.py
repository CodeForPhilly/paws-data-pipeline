def recency_score(donations_df, query_date):
    ''' takes the grouped dataframe and outputs bins for recency scores
    '''
    ...
    return donations_df, recency_bins, quantile_scores
